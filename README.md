...
Com relatório de pedidos agrupados e totalizados por mês (SOMENTE a SQL).

Seja criativo(a) quanto as propriedades das entidades, pense nos valores mais comuns para Pedido (Itens, cliente, data de entrega, etc) e Produto (nome, preço, código, código de barras, etc).
